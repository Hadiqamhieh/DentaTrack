  ...
  return (
    <div className="dt-modal-overlay" style={{ position:"fixed",inset:0,background:"rgba(0,0,0,0.45)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:1000 }}>
      {showScan&&<ScanModal title="Scan Day Sheet"
        prompt="Read a dental day sheet / production report. Extract: date (YYYY-MM-DD), total_production (number), total_collection (number if visible), total_lab_fees (number if visible). Do not include any patient names or other patient-identifying information anywhere in your response, even if visible on the sheet."
